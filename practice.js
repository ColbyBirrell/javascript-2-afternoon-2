...
function looper(family) {
  for (i = 0; i < family.length; i++) alert(family[i]);
}
...
function reversedLooper(letters) {
  for (i = letters.length - 1; i >= 0; i--) alert(letters[i]);
}
...
var user3 = {
  name: "bill",
  email: "dude@didkjaf;s",
  password: "hr2",
  username: "dfads"
};

users.push(user1, user2, user2);
